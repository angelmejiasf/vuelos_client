...
require_once './controllers/VuelosController.php';
require_once './views/VuelosView.php';
require_once './views/AeropuertoView.php';
require_once './controllers/AeropuertoController.php';
require_once './controllers/PasajeController.php';
require_once './views/PasajeView.php';


// Define la acción por defecto
define('ACCION_DEFECTO', 'mostrarOpciones');//**NOMBRAR LA FUNCION POR DEFECTO**

// Define el controlador por defecto
define('CONTROLADOR_DEFECTO', 'Aeropuerto');//**NOMBRAR AL CONTROLADOR POR DEFECTO
